...
test("form shows success message on submit with form details", async() => {
    ...
    await userEvent.type(firstNameInput, 'samantha');
    expect(firstNameInput).toHaveValue('samantha'); 

    const lastNameInput = getByLabelText(/last name/i); 
    await userEvent.type(lastNameInput, 'voncannon');
    expect(lastNameInput).toHaveValue('voncannon'); 
